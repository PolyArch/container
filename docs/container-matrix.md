...
| Synopsys / DSO.ai `dsoai/Y-2026.03-SP4` | not yet validated | not yet validated | ok: `dso_shell -help` reports SP4 | not yet validated | ok: `dso_shell -gui` reached the DSO.ai prompt through EL9 Xvnc |
...
| Synopsys / Custom Compiler `customcompiler/Y-2026.03-SP2` | not yet validated | not yet validated | ok: vendor GUI process remained running through `container gui` | not yet validated | ok: Custom Compiler GUI startup through the managed EL9 Xvnc display |
| Synopsys / Custom Infrastructure `custominfrastructure/Y-2026.03-SP2` | not yet validated | not yet validated | ok: `cnversion -V` reports Y-2026.03-SP2 | not yet validated | n/a: shared custom-design runtime |
| Synopsys / PrimeWave Reliability `primewavereliability/Y-2026.03-SP2` | not yet validated | not yet validated | ok: module loads matching Custom Compiler and `primewave_reliability -help` reaches the Custom Compiler command path | not yet validated | n/a: integrated Custom Compiler environment |
